...
import {Company, Item, ItemType, OrderCategory, Shelf, Status} from "@prisma/client";
...
const SummaryDetailsItemsContainer: FC<SummaryDetailsItemsContainerProps> = ({title, placeId, items, ...rest}) => {
    return (
        <details {...rest}>
            <summary
                className="flex items-center my-5 p-2 cursor-pointer rounded-xl transition-colors duration-200 hover:bg-gray-200">
